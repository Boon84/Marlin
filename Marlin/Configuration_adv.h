 ...
 */
#define E0_AUTO_FAN_PIN P2_03 //-1 //rado
...
#define HOMING_BACKOFF_POST_MM { 4, 4, 0 }  // (mm) Backoff from endstops after homing
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //rado
#if ENABLED(Z_STEPPER_AUTO_ALIGN)
  // Define probe X and Y positions for Z1, Z2 [, Z3 [, Z4]]
  // If not defined, probe limits will be used.
  // Override with 'M422 S<index> X<pos> Y<pos>'
  #define Z_STEPPER_ALIGN_XY { {  50, (Y_BED_SIZE/2) }, { 280,  (Y_BED_SIZE/2) } }  //rado   , { 190, 190 } }
...
#define DISABLE_INACTIVE_Z false //rado  // Set to false if the nozzle will fall down on your printed part when print has finished.
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING //rado
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define TURBO_BACK_MENU_ITEM //rado
 ...
 */
#define BABYSTEPPING //rado
#if ENABLED(BABYSTEPPING)
  #define INTEGRATED_BABYSTEPPING         //rado  // EXPERIMENTAL integration of babystepping into the Stepper ISR
 ...
 */
  ...
  #define PROBE_PT_2_X 280
  #define PROBE_PT_2_Y 70
 ...
 */
  ...
  #define MESH_MIN_Y (MESH_INSET + 5) //rado important UBL front row
...
#define TX_BUFFER_SIZE 32 //rado 0
 ...
 */
#define ADVANCED_PAUSE_FEATURE //rado
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  350 //X_CURRENT  // (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT_HOME  350 //Y_CURRENT
    #define Y_MICROSTEPS     16
   ...
   */
  #define MONITOR_DRIVER_STATUS //rado "knocking"
   ...
   */
  #define SQUARE_WAVE_STEPPING //rado "important for extruder"

  /**
   * Enable M122 debugging command for TMC stepper drivers.
   * M122 S0/1 will enable continous reporting.
   */
  #define TMC_DEBUG //rado
...
#define MEATPACK //rado               // Support for MeatPack G-code compression (https://github.com/scottmudge/OctoPrint-MeatPack)
