...
#define DISABLE_INACTIVE_Z false //rado  // Set 'false' if the nozzle could fall onto your printed part!
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.02, 0.02, 0 } // (mm) One value for each linear axis
